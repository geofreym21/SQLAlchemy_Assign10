...
<img src="https://cdn.pixabay.com/photo/2016/08/30/12/13/beach-1630540__480.jpg" alt="Hawaii"/>
...
def precipitation():
        ...
        prcptn_data = session.query(Measurement.date, Measurement.prcp).\
                filter(Measurement.date >= one_year_ago).\
                order_by(Measurement.date).all()
        # Convert List of Tuples Into a Dictionary
        prcptn_data_list = dict(prcptn_data)
        # JSON Representation of Dictionary
        return jsonify(prcptn_data_list)
...
def start_day(start):
        ...
        # JSON List of Min Temp, Avg Temp and Max Temp for a Given Start Range
...
def start_end_day(start, end):
        ...
        # JSON List of Min Temp, Avg Temp and Max Temp for a Given Start-End Range
